...
public class DataCollector {
    ...
    public void benchmark() throws Exception {
        String svgFile = "figures/StudySyncData.svg";
    ...
    private static void generateSvg(String path, long[] totalMs) throws IOException {
        ...
        s.append(String.format(
            ...
            "text-anchor='middle' fill='#222'>StudySync - Canvas Fetch Time per Run</text>\n",
            svgW / 2));
        s.append(String.format(
        ...
        for (int i = 0; i < n; i++) {
            double barH = (double) totalMs[i] / maxVal * chartH;
